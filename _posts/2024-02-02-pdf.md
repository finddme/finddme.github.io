...
- **방법1**
  - text: layout detection 이후 bbox내 text 추출, 
    ...
    - [detection : PDFQuery](https://finddme.github.io/dev%20log/2024/02/02/pdf/#131-pdf-to-xml-%EC%8B%9C%EA%B0%81%ED%99%94)
    - [text 추출 : PyMuPDF](https://finddme.github.io/dev%20log/2024/02/02/pdf/#132-pdf-to-xml%EC%9D%84-%ED%86%B5%ED%95%B4-%EA%B0%90%EC%A7%80%EB%90%9C-bbox-%EB%82%B4-text-%EC%B6%94%EC%B6%9C)
...
## 1.1 microsoft/Florence-2-large
...
### 1.3.2 PDF to xml을 통해 감지된 bbox 내 text 추출
