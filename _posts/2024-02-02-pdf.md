...
- **방법1**
  - text: layout detection 이후 bbox내 text 추출, 
    ...
    - [detection : PDFQuery](https://finddme.github.io/dev%20log/2024/02/02/pdf/#141-pdf-to-xml-%EC%8B%9C%EA%B0%81%ED%99%94)
...
- 표 삽입 형식과 무관하게 pdf 내 텍스트 위치 파악도 못 하고 텍스트 추출도 못 함. 일반적인 그림 혹은 사진에 대한 object detection과 광고 포스터에 대한 OCR 능력은 좋지만 PDF OCR에는 적합하지 않은 모델로 보임.
...
### 1.4.2 PDF to xml을 통해 감지된 bbox 내 text 추출
