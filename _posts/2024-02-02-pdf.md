...
- Pirma output 시각화 1 (표가 그림으로 삽입된 페이지)
...
- Pirma output 시각화 2 (표가 문서 내 표로 삽입된 페이지)
  
<center><img width="800" src="https://github.com/finddme/finddme.github.io/assets/53667002/8dd8085e-7387-4a28-911c-7ac8c3ac7691"></center>
<center><em style="color:gray;">Pirma detection result</em></center><br>

### 1.1.2 HJDataset 

- HJDataset output 시각화 1 (표가 그림으로 삽입된 페이지)
...
- HJDataset output 시각화 2 (표가 문서 내 표로 삽입된 페이지)
  
<center><img width="800" src="https://github.com/finddme/finddme.github.io/assets/53667002/5d19bfc3-c15b-4205-89ec-d540ed4d4ea1"></center>
<center><em style="color:gray;">Pirma detection result</em></center><br>

### 1.1.3 PubLayNet 

- PubLayNet output 시각화 1 (표가 그림으로 삽입된 페이지)
  
<center><img width="800" src="https://github.com/finddme/finddme.github.io/assets/53667002/8948f670-7c6e-47cc-99c4-e0e0c131cec4"></center>
<center><em style="color:gray;">PubLayNet detection result</em></center><br>

- PubLayNet output 시각화 2 (표가 문서 내 표로 삽입된 페이지)
  
<center><img width="800" src="https://github.com/finddme/finddme.github.io/assets/53667002/7f59ce81-dd07-40d7-bc4e-6b3b364963a8"></center>
<center><em style="color:gray;">Pirma detection result</em></center><br>
...
- 표가 문서 내 표로 삽입된 페이지
- 
<center><img width="800" src="https://github.com/finddme/finddme.github.io/assets/53667002/2cde5351-f7ba-4280-9633-73075ac1160b"></center>
<center><em style="color:gray;">PDFQuery detection result</em></center><br>
...
<center><em style="color:gray;">PyMuPDF text extraction result 표:그림</em></center><br>

<center><img width="500" src="https://github.com/finddme/finddme.github.io/assets/53667002/ee0d060e-6a2f-4ed1-aa36-4e11a67a3553"></center>
<center><em style="color:gray;">PyMuPDF text extraction result 표:표</em></center><br>
...
<center><em style="color:gray;">camelot-py table detection result(Illustrated by the author)</em></center><br>
 ...
 <center><img width="500" src="https://github.com/finddme/finddme.github.io/assets/53667002/9dcfcab6-6322-42ba-9d37-ab3615232def"></center>
<center><em style="color:gray;">camelot-py table text extraction</em></center><br> 
