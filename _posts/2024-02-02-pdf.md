...
- **방법1**
  - text: layout detection 이후 bbox내 text 추출, 
    ...
    - [detection : PDFQuery](https://finddme.github.io/dev%20log/2024/02/02/pdf/#12-pdf-to-xml)
    - [text 추출 : PyMuPDF](https://finddme.github.io/dev%20log/2024/02/02/pdf/#122-pdf-to-xml%EC%9D%84-%ED%86%B5%ED%95%B4-%EA%B0%90%EC%A7%80%EB%90%9C-bbox-%EB%82%B4-text-%EC%B6%94%EC%B6%9C)
