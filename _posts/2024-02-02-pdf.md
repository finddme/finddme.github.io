...
- 최종 개발물로 올린 데모
  ...
  - Title과 Text 그리고 Figure 위치를 분리하여 추출 양호
  - 추출된 layout 내 text 추출 성능 양호
 
  - 개선 예정
    - table 내 한국어 추출 성능이 좋지 않아 이 부분 수정 예정

      <center><img width="1000" src="https://github.com/finddme/finddme.github.io/assets/53667002/a12884f4-843f-443e-849e-6f4af6b23689"></center>
      <center><em style="color:gray;">최종 개발물 데모 (table 추출)</em></center><br>
