...
<center><img width="228" alt="2021-03-27 (1)" src="https://user-images.githubusercontent.com/53667002/112919879-ddccfd00-9142-11eb-9d0e-ede02fbbdf53.png"></center>  
2차원 공간에 encoding된 것을 선형 변형시키면 tree가 보인다:  
<center><img width="222" alt="2021-03-27 (2)" src="https://user-images.githubusercontent.com/53667002/112919925-ee7d7300-9142-11eb-96a3-093cfb672fb7.png"></center>
...
코퍼스 내 문장  $s_{l}$과 $\frac{1}{{\left| s_{l} \right|}^2}$ index$l$은  각 문장의 단어 쌍 수를 normalize한다. 중요한 것은 tree distance와 squared distance ${\lVert {h_i}-{h_j} \rVert}\_{B}^{2}$ 의 차이를 최소화해야 한다는 것이다. (실제 vector 거리 ${\lVert h_i - h_j \rVert}\_{B}$가 항상 실제 parse tree distance에서 벗어나지만 encoding된 tree정보는 일치하며, squared distance로 최적화하는 것이 가장 효과적이기 때문이다.)
...
\begin{matrix}
\underset{B}{\min}\sum_{l}\frac{1}{\left| s_{l} \right|}\sum_i(\lVert w_i \rVert-{\lVert Bh_i \rVert}^2)
\end{matrix}
