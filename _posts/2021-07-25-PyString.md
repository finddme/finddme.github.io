...
## <span style="background-color:#EDDBCA">문자열(str.character string) 자료형</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | Escape code</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 연산</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | Indexing</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | Slicing</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | Slicing | Step</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | replace("기존 원소", "변경할 원소")</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | count("원소")</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | find("원소")</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | upper()</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | lower()</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | split()</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | zfill(자리수)</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | int(문자열)</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | 문자열 뒤집기(slicing 사용)</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | len(문자열)</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | isalpha()</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | isdigit()</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | isalnum()</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | join(리스트 자료형)</span>
...
```
 ...
 ### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | sorted(문자열 자료형)</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | (sorted + join)</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | split(토큰)</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | find(서브문자열)</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | upper(), lower()</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | strip()</span>
...
### <span style="background-color:#EDDBCA">문자열 자료형 | 함수 | eval()</span>
