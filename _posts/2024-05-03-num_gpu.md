---
title: "Calculate GPU Requirements and Trainable Parameters(original,lora,quantization)"
...
- LoRA나 quantization이 적용된 경우, Trainable Parameter를 계산하여 적용.
  - [LoRA](https://finddme.github.io/llm%20/%20multimodal/2024/01/21/lora/#lora)는 original model의 parameter가 frozen된 상태로 추론처럼 사용되기 때문에 해당 모델이 추론에 소요되는 GPU수 +  LoRA를 적용한 Trainable Parameter에 대한 필요 GPU 수로 계산하면 될 것으로 보임.
...
def calculate_gpus(model_params_in_B, lora_trainable_params_in_B, gpu_size):
