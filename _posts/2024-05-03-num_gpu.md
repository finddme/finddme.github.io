...
- 일반적으로 LoRA는 self attention layer weights matrix에 적용되기 때문에 해당 matrix의 크기가 1024x512이고 LoRA rank를 8로 설정했을 때 Trainable Parameters는 1024×8 + 512×8로 계산될 수 있다.
...
<table border="0" cellpadding="0" cellspacing="0" width="374" style="">
  <thead>
    <tr height="23" style="height:17.4pt">
      <th colspan='3' align=center>Inference</th>
    </tr>
  </thead>
