             ...
             <br>
              ...
              <li><strong>수행 업무 요약</strong></li>
                 ...
                 - 데이터 수집
                    ...
                    \textbf{출처}                                                & \textbf{수량}        \\ \hline
                    data labeling 업체 수집 데이터(raw data: web crawling data)       & 302,028문장          \\ \hline
                    data labeling 업체 수집 데이터(raw data: aihub 한국어 SNS, 자유대화 데이터) & 184,585문장          \\ \hline
                    aihub data (한국어 단발성 대화 데이터셋: 기쁨, 슬픔, 놀람, 분노, 공포, 혐오, 중립)   & 37,000문장           \\ \hline
                    aihub data (감성 대화 말뭉치: 기쁨, 당황, 분노, 불안, 상처, 슬픔)             & 28,000문장           \\ \hline
                    \rowcolor[HTML]{EFEFEF} 
                    \textbf{총 수량}                                              & \textbf{551,613문장} \\ \hline
                    \end{tabular}
                    \end{table}
                - 데이터 수집
