   ...
   <body>
     <table style="border-collapse:collapse">
       ...
       <tr>
         ...
         <td class="line">
           <details>
           <summary style="cursor: pointer;" onmouseover="this.style.fontWeight='bold'; this.style.color='#003876'; this.style.backgroundColor='#656668'" onmouseout="this.style.fontWeight=''"><span class="glyphicon glyphicon-menu-right"></span>
