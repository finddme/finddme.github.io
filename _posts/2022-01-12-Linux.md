  ...
  <head>
   ...
   <body>
     <table style="border-collapse:collapse">
       ...
       <tr><td class="line3"> </td><td class="line3"> </td><td class="line3"><span style="color:#648BC6; font-weight: bold; border-bottom: none;">File Commands</span></td><td class="line3"> </td></tr>
       ...
       <tr><td class="line2">-al</td><td class="line">감춰진 파일 더 자세히</td><td class="line"> </td></tr>
       <tr><td class="line2">-alS</td><td class="line">감춰진 파일 더 자세히, 파일 크기를 기준으로 sort</td><td class="line"> </td></tr>
       ...
       <tr><td class="line2">-r [디렉토리 이름]</td><td class="line">디렉토리 삭제</td><td class="line">rm -r testdirectory</td></tr>
       <tr><td class="line3" rowspan="1">cp</td><td class="line">A B</td><td class="line">A를 B에 복사</td><td class="line">cp test.txt ./test2<br>(현재 디렉토리에 있는 test.txt를 ./test2에다 복사)</td></tr>
       <tr><td class="line3" rowspan="2">mv</td><td class="line">A B</td><td class="line">A를 B에 옮기기</td><td class="line">mv ./test/test.txt ./test2<br>(./test에 있는 test.txt를 ./test2에 옮긴다.)</td></tr>
