...
이와 관련하여 McCoy et al. (2018) 연구를 살펴보도록 하겠다. 해당 연구에서는 모델의 yes/no question formation 학습 여부를 테스트하였는데, 여기에서 사용된 모델은 seq2seq[(seq2seq에 대해 자세히 알고자 한다면 여기를 누르세요)](https://finddme.github.io/natural%20language%20processing/2019/11/11/Seq2Seq/)이다. 
