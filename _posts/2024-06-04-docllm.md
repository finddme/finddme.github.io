...
DocVQA, WikiTableQuestions(WTQ), VisualMRC, DUDE, BizDocs2를 수집하여 VQA instruction-tuning data mix를 구성한다. VQA 학습 시 input은 위 표에 나타난 바와 같이 하나의 instruction template이다.
