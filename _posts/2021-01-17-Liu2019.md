...
<img width="277" alt="2021-03-06 (3)" src="https://user-images.githubusercontent.com/53667002/110228670-334c2a80-7f46-11eb-90e5-81968eba72e2.png">
...
4\)**OpenAI transformer**: left-to-right 12-layer transformer language model로, contiguous text from over 7,000 unique unpublished books (BookCorpus; Zhu et al., 2015) 800M token으로 훈련되었다.
...
6) BERT (base, cased): 12-layer transformer 사용
7) BERT (large, cased): 24-layer transformer 사용
